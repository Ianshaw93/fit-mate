...
import DjangoArticle from '../public/djangoJsArticle.jpeg'
import swivelCameraGif from '../public/threeJsSwivelCamera.gif'
//src\assets\airbnbLogo.jpeg
//src\assets\swivelCameraGifSquare.PNG
const Articles = () => {
  return (
    // <div name='articles' className='w-full md:h-screen'>
    <div id={'articles'} className='w-full md:h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-[#9CC9B7]'>Articles</p>
...
Three JS 3D Scene Panoramic Camera
          ...
          {/* TODO: pull in followers for medium */}
    </div>
